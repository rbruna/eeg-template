...
%             scatter3 ( src ( :, 1 ), src ( :, 2 ), src ( :, 3 ), [], colors, 'filled' )
            scatter3 ( src ( :, 1 ), src ( :, 2 ), src ( :, 3 ), 10, colors, 'filled' )
            ...
            set ( gca, 'CameraPosition', [ 0.00 0.00 0.04 ] + ori * 2.2 )
            set ( gca, 'CameraTarget', [ 0.00 0.00 0.04 ] )
        end
    end
